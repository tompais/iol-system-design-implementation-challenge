...
| `capacity_enforcement` | CAPACITY×10 (100) sequential requests on same key | first CAPACITY (10): 200 · rest CAPACITY×9 (90): 429 |
...
✓ missing key → 400
✓ blank key → 400
✓ capacity enforcement → expected status (200 or 429)
